...
const tabs = ref([
    ...
    { title: '部分发货', value: '2010', hidden: true },
    { title: '已取消', value: '1005', hidden: true },
    { title: '待核销', value: '1012', hidden: true },
    { title: '已发货', value: '1003' },
    { title: '已完成', value: '1004' },
]);
const columns = ref([
    { label: '全选', width: 40, type: 'selection', 'reserve-selection': true, prop: 'index' },
    { label: '订单号', minWidth: 120, prop: 'soOrderCode' },
    { label: '包裹号', minWidth: 120, prop: 'packageCode', slot: true },
    { label: '商品', minWidth: 260, prop: 'sku', slot: true },
    ...
    { label: '操作', width: 80, align: 'left', prop: 'operate', slot: true },
])
