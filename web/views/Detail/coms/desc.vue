...
import { GoodsDetail, Sku, RateData } from '@/views/Detail/data.d';
              ...
              <el-tab-pane label="规格参数" name="2">
                  <div class="others">
                      <el-form label-width="300px">
                          ...
                          <el-form-item :label="groups[0].groupName" v-for="groups in goodsAttributes" :key="groups[0].groupCode" label-width="70px">
                              <el-form-item :label="group.attributeName+'：'"  v-for="group in groups" :key="group.groupCode">{{ group.attributeValueName }}</el-form-item>
                          </el-form-item>
                      </el-form>
                  </div>
              </el-tab-pane>
                              ...
                              <div class="rate-list-item flex" v-for="item in goodsComment.records" :key="item.id">
                                  ...
                                  <el-form inline class="content tl flex-2" style="width: 100%;">
                                      ...
                                      <el-form-item style="width: 800px;">
                                          <p>{{ item.content }}</p>
                                          <div class="img-list">
                                              <el-image style="width: 60px;height: 60px;" class="mr20" v-for="image in item.imgUrls.split(',').filter(_=> _)" :key="image" :src="image" :preview-src-list="item.imgUrls.split(',').filter(_=> _)"></el-image>
                                          </div>
                                      </el-form-item>
