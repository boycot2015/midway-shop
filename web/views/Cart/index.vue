        ...
        <div class="cart-content w1200">
            ...
            <div class="cart-list">
                ...
                >
                    ...
                    <template #num="{row}">
                        <el-input-number v-model="row.quantity" :mini="row.minimumOrderQuantity" :max="999" ></el-input-number>
        ...
        <div class="settment">
            <div class="w1200 flex flex-justify-between flex-center settment-box">
                ...
                <div class="total flex flex-center">
                    ...
                    <el-button type="danger" :disabled="!!totalQuantity">去结算</el-button>
                </div>
            </div>
        </div>
    </div>
...
const columns = ref([
    ...
    { label: '小计', prop: 'amount', slot: true },
...
const selection = ref({
    checkAll: true,
    showCheckAll: false,
    selectedRows: computed(() => cartStore.selectedGoodsList).value || [],
